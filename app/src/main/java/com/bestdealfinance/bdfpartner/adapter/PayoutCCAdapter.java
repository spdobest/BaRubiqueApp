 ...
 */
public class PayoutCCAdapter extends RecyclerView.Adapter<PayoutCCAdapter.ViewHolder> {
...
//                profile = (ImageView) itemView.findViewById(R.id.circleView);// Creating Image view object from header.xml for profile pic
    ...
    public PayoutCCAdapter(Context ctx, List<String> pay, List<String> pay_app, List<String> type) { // PayoutCCADapter Constructor with titles and icons parameter
    ...
    @Override
    public PayoutCCAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PayoutCCAdapter.ViewHolder holder, int position) {
